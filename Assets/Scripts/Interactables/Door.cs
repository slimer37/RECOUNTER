...
namespace Recounter.Interactables
{
    public class Door : Interactable
    {
        [SerializeField] HudInfo _hud = new()
        {
            icon = Icon.Door,
            text = "Push or Pull"
        };
        ...
        protected override HudInfo FormHud(Employee e) => _hud;

        [Button("Normalize Pull Direction")]
        void NormalizeAxis() => _pullDirection.Normalize();
